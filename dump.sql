...
ALTER TABLE public.account OWNER TO shovikghosh;
...
ALTER TABLE public.account_id_seq OWNER TO shovikghosh;
...
ALTER TABLE public.phone_number OWNER TO shovikghosh;
...
ALTER TABLE public.phone_number_id_seq OWNER TO shovikghosh;
...
REVOKE ALL ON SCHEMA public FROM shovikghosh;
GRANT ALL ON SCHEMA public TO shovikghosh;
